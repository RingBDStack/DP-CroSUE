...
def load_config(model_name, dataset_str, optimizer):
    ...
    elif model_name == 'DPGGAN' and optimizer == 'ADADP':
        return DPGGAN_imdb_ADADP()
    elif model_name == 'DPGGAN' and  optimizer == 'Adam':
        return DPGGAN_imdb_Adam()
    elif model_name == 'DPGVAE' and optimizer == 'ADADP':
        return DPGVAE_imdb_ADADP()
    elif model_name == 'DPGVAE' and  optimizer == 'Adam':
        return DPGVAE_imdb_Adam()
    else:
